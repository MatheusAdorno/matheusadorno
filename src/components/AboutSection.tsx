  ...
  return (
    <section className="py-24 lg:py-32">
      <div className="container mx-auto px-6 lg:px-16">
        ...
        >
          <h2 className="font-heading text-sm tracking-[0.2em] uppercase text-muted-foreground mb-12 text-center">
            Sobre
          </h2>

          <div className="space-y-6 text-base md:text-lg leading-relaxed text-foreground/85 font-body font-light text-center">
            <p>
